...
public class T002ValidateNumberLeftColRightReviewScreen extends TestBase{
		...
		public T002ValidateNumberLeftColRightReviewScreen(){
			super();
		}
		...
		public void loginTest() throws Exception {
			...
			reviewPage.validateColHeaderReviewScreenAndIncomeStmt();
